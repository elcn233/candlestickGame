...
### 管理员命令列表：
#### /sf
##### 注释：/sf为上分命令，使用格式：/sf+空格+用户UserID+空格+金额，例如：/sf 123456789 100
##### 详情文档：[管理员上分开发文档](#管理员上分开发文档)
#### /xf
##### 注释：/xf为上分命令，使用格式：/xf+空格+用户UserID+空格+金额，例如：/xf 123456789 100
##### 详情文档：[管理员下开发文档](#管理员下分开发文档)
#### /help
##### 注释：/help为管理员帮助命令，使用格式：/help，例如：/help
